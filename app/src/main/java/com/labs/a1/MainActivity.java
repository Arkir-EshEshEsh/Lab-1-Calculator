...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vResultText = findViewById( R.id.result_text_view );
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            if( TextUtils.isEmpty(etNum1.getText().toString()) ) {
                ...
                toastError = Toast.makeText( this,  R.string.input_first, duration );
            } else if( TextUtils.isEmpty(etNum2.getText().toString()) ) {

                toastError = Toast.makeText( this,  R.string.input_second, duration );
            } else {
        ...
        if( correctOperation ) {
            ...
            vResultText.setText( getString(R.string.result) + " " + num1 + " " + operation + " " + num2 + " = " + result );
        } else {
